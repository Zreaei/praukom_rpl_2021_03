    ...
    <div class="mt-16">
        <div class="flex gap-7 m-5">
            <div class="w-44 p-6 bg-white border-gray-200 rounded-lg shadow-md dark:border-gray-700">
                ...
                <div class="text-center">
                    <a href="admin/data-log" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-2">
                        Log User
                    </a>
                </div>
            </div>
