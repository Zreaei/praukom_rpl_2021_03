...
<div class="px-28 py-7 w-full justify-center items-center">
    <div class="flex justify-between">
        <h3 class="text-2xl font-bold text-[#2D5EBB] mx-auto">DATA JURUSAN</h3>
    </div>
<div>
...
<div class="w-2/3 rounded mt-5 border-slate-500 mx-auto">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center bg-white">
                    <label for="modal-edit{{ $item->id_jurusan }}" class="btn btn-circle btn-outline btn-xl btn-warning hover:text-opacity-50">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                    </label>
                    <label for="modal-hapus{{ $item->id_jurusan }}" class="btn btn-circle btn-outline btn-xl btn-error hover:text-opacity-50 justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div>
        <div class="m-3 text-center">
            {{-- Modal Button --}}
            <label for="modal-tambah" class="btn btn-success hover:text-opacity-50">Tambah Jurusan</label>
                                    ...
                                    <div class="form-control m-5">
                                        <label class="input-group justify-center">
                                            ...
                                            <select class="select select-bordered" name="kaprog">
                                                <option value="">Nama Kaprog</option>
