...
<div class="px-28 py-7 w-full justify-center items-center">
    <div class="flex justify-between">
        <h3 class="text-2xl font-bold text-[#2D5EBB] mx-auto">DATA ADMKEU</h3>
    </div>
<div>
...
<div class="w-1/2 rounded mt-5 border-slate-500 mx-auto">
    <div class="overflow-x-auto">
        ...
        <thead>
            <tr>
                <th class="text-center bg-blue-700 text-white">id_admkeu</th>
        ...
        @foreach ($dataAdmkeu as $item)
        <tbody>
            <!-- row 1 -->
            <tr>
                <td class="text-center bg-white"><h1>{{ $item->id_admkeu }}</h1></td>
