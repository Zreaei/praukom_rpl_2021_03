    ...
    <div class="py-5 px-32 flex justify-between items-center w-full ">
        <div class="card bg-gradient-to-b from-[#2D5EBB] to-[#417EF2] shadow-xl ">
            ...
            <div class="card-body items-center text-center h-80">
                <h2 class="card-title text-3xl text-white font-bold">Agus</h2>
                <h2 class="card-title text-lg pt-5 font-bold">Sebagai :</h2>
                <div class="card-actions py-2">
                    <div class="grid justify-items-center w-full px-32 bg-gradient-to-b from-[#FFA434] to-[#D24E16] p-3 rounded-lg">
                        <span class="font-bold uppercase text-xl text-white">{{Auth::user()->username}}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card w-full px-10">
            ...
            <div class="flex justify-between rounded-lg bg-white mt-2 h-28 w-full">
                ...
                <div class="text-2xl text-black py-10 w-96">
                    <div class="grid justify-items-start">
                        <span class="font-medium text-xl"><span class="text-2xl font-bold pr-10">:</span>Danare</span>
                    </div>
            ...
            <div class="flex justify-between rounded-lg bg-white mt-2 h-28 w-full">
                ...
                <div class="text-2xl text-black py-10 w-96">
                    <div class="grid justify-items-start">
                        <span class="font-medium text-xl"><span class="text-2xl font-bold pr-10">:</span>muhdankah22@gmail.com</span>
                    </div>
