                    ...
                    @foreach ($dataPengajuan as $item)
                        <tr class="bg-[#ffffff] text-[#000000]">
                            <td class="text-sm text-item font-semibold px-5 py-4 text-center">
                                <label for="detail-siswa{{ $item->nis }}" type="button" class="text-[#ffffff] bg-[#0029FF] hover:bg-opacity-50 focus:outline-none focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5">Data Siswa</label>          
                            </td>
                            <td class="text-sm text-item font-semibold px-7 py-4 text-center">
                                {{ $item->tgl_pengajuan }}
                            </td>
                            <td class="text-sm text-item font-semibold px-5 py-4 text-center">
                                <label for="detail-IDUKA{{ $item->id_iduka }}" type="button" class="text-[#ffffff] bg-[#FFA434] hover:bg-opacity-50 focus:outline-none focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5">Data IDUKA</label>          
                            </td>
                            <!-- icon Aksi -->
                            <td class="text-sm font-medium leading-5 text-center [#ffffff]space-no-wrap ">
                                <div class="flex justify-center">
                                    <div class="px-4 py-4">
                                        <label for="validasi{{ $item->id_pengajuan }}" class="text-[#2D5EBB] hover:text-opacity-50">
                ...
                <div class="modal-box w-full max-w-2xl bg-[#2D5EBB]">
                    ...
                    <div class="flex justify-between mt-5">
                        ...
                        <div class="form-control w-full max-w-sm mr-2">
                            <label class="label">
                                <span class="label-text text-[#ffffff] text-sm font-bold uppercase ">Wali kelas</span>
                            </label>
                        ...
                        <div class="form-control w-full max-w-sm">
                            <label class="label">
                                <span class="label-text text-[#ffffff] text-sm font-bold uppercase ">ADMIN KEUANGAN</span>
                            </label>
                    ...
                    <div class="flex justify-between mt-5">
                        ...
                        <div class="form-control w-full max-w-sm mr-2">
                            <label class="label">
                                <span class="label-text text-[#ffffff] text-sm font-bold uppercase ">Waka hubin</span>
                            </label>
                        ...
                        <div class="form-control w-full max-w-sm">
                            <label class="label">
                                <span class="label-text text-[#ffffff] text-sm font-bold uppercase ">kepala program</span>
                            </label>
                    ...
                    {{-- Konfirmasi Walas --}}
                    @if($validasi->konfirmasi_walas == "pending")
