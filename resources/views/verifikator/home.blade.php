...
<div class="flex">
    <div class="fixed w-20 mt-8 overflow-y-auto bg-gray-50 rounded-r-lg bg-gradient-to-b from-[#2D5EBB] to-[#417EF2]">
    ...
    <div class="p-10 w-4/5 mx-auto">
        <div class="flex gap-7 justify-between mt-44">
            <div class="w-full max-w-xl h-full max-h-64 shadow-md hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg">
                <a href="profile">
            ...
            <div class="w-full max-w-xl h-full max-h-64 shadow-md hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg">
                <a href="penilaian">
                    ...
                    <div class="card-body bg-white rounded-lg bg-opacity-30">
                        <h5 class="text-2xl font-bold tracking-tight text-white text-center">PENILAIAN</h5>
                    </div>
                </a>
            </div>
        </div>
