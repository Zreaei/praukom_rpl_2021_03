...
<div>
    ...
    <div class="py-10 px-32 justify-center items-center w-full">
        ...
        <div class="flex justify-between h-96 gap-5 mt-16">
            <div class="w-full h-full card border border-white hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg shadow">
                <a href="{{ route('admkeu.profile') }}">
                    <div class="flex justify-center py-20 p-5">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-32 h-32 text-white"><path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clip-rule="evenodd" /></svg>
                    </div>
            ...
            <div class="w-full h-full card border border-white hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg shadow ">
                <a href="{{ route('admkeu.pengajuan') }}">
                    <div class="flex justify-center py-20 p-5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-32 h-32 text-white"><path fill-rule="evenodd" d="M19.5 21a3 3 0 003-3V9a3 3 0 00-3-3h-5.379a.75.75 0 01-.53-.22L11.47 3.66A2.25 2.25 0 009.879 3H4.5a3 3 0 00-3 3v12a3 3 0 003 3h15zm-6.75-10.5a.75.75 0 00-1.5 0v4.19l-1.72-1.72a.75.75 0 00-1.06 1.06l3 3a.75.75 0 001.06 0l3-3a.75.75 0 10-1.06-1.06l-1.72 1.72V10.5z" clip-rule="evenodd" /></svg>
                    </div>
                    <div class="card-body bg-white rounded-lg bg-opacity-30 ">
                        <h5 class="text-2xl font-bold tracking-tight text-white text-center">PENGAJUAN SISWA</h5>
                    </div>
                </a>
            </div>
        </div>
