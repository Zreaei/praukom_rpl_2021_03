...
<div class="">
                    ...
                    ?>
                        ...
                        <tr class="bg-[#ffffff] text-[#000000]">
                            ...
                            <td class="text-sm font-medium leading-5 text-center [#ffffff]space-no-wrap ">
                                <div class="flex justify-center">
                                <div class="px-4 py-4">
                                        <a href="/pbsekolah/terima/{{ $item->tgl_presensi }}" class="text-indigo-600 hover:text-indigo-900">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    ...
                                    <div class="px-4 py-4">
                                        <a href="/pbsekolah/tolak/{{ $item->tgl_presensi }}" class="text-indigo-600 hover:text-indigo-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
