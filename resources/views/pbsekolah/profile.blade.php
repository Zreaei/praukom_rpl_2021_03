    ...
    <div class="py-5 px-32 justify-center items-center w-full">
        <div class="card w-96 bg-gradient-to-b from-[#2D5EBB] to-[#D24E16] shadow-xl ">
            ...
            <div class="card-body items-center text-center">
                <h2 class="card-title font-bold">{{ $user->id_user }}</h2>
                <div class="card-actions ">
                    <div class="grid justify-items-center px-32 bg-gradient-to-b from-[#FFA434] to-[#D24E16] p-3 rounded-lg">
                        <span class="font-bold uppercase text-white">{{ $item->nama_pbsekolah }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body text-4xl text-white pt-5 justify-center items-center w-4/5">
                ...
                <div class="justify-center w-full mt-5 px-32">
                    <div class="grid justify-items-center bg-gradient-to-b from-[#FFA434] to-[#D24E16] p-3 rounded-lg">
                        <span class="font-semibold uppercase">Siswa</span>
                    </div>
                </div>
            </div>
