...
<div class="flex bg-gray-100">
    ...
    <div class="container ">
        <div class="px-7 w-full justify-center items-center">
            ...
            <div class="grid gap-4 gird-cols-2 py-5">
                <h3 class="text-2xl font-bold text-danar">FORM DATA PRESENSI</h3>
            </div>
            <div class="card ">
                <div class="card-body bg-danar rounded-lg">
                    <form action="{{ route('siswa.simpanpresensi') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="form-control w-full max-w-sm mr-2">
                                ...
                                <select class="select select-bordered bg-white" name="status_agenda">
                            ...
                            <div class="form-control w-full max-w-sm">
                                ...
                                <input type="text" name="keterangan_agenda" placeholder="Type here" class="input input-bordered w-full max-w-sm bg-white" />
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="form-control w-full max-w-sm mr-2">
                                ...
                                <input type="date" name="tgl_agenda" placeholder="Type here" class="input input-bordered w-full max-w-sm bg-white" />
                            </div>
                            <div class="form-control w-full max-w-sm">
                                <label class="label-text text-white text-lg font-bold">Foto</label>
                                <input type="file" name="foto" placeholder="Type here" class="input input-bordered w-full max-w-sm bg-white px-4 py-2" />
                            </div>
                        </div>
