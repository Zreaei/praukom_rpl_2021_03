...
<div class="flex bg-gray-100">
    ...
    <div class="px-3 py-4 overflow-y-auto bg-gray-50 h-screen bg-gradient-to-b from-danar to-kahfi">
        <ul class="space-y-2">
            <h3 class="font-bold text-oren text-2xl pl-7 mb-10">ONE<span class="block">PRAKTIK.in</span></h3>
            <li>
                <a href="{{ route('siswa.pengajuan') }}" class="flex items-center p-2 text-xl font-bold text-white rounded-lg hover:bg-white hover:bg-opacity-30 active:bg-white active:bg-opacity-30 focus:bg-white focus:bg-opacity-30">
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-xl font-bold text-white rounded-lg hover:bg-white hover:bg-opacity-30 active:bg-white active:bg-opacity-30 focus:bg-white focus:bg-opacity-30 mt-8">
            ...
            <li>
                <a href="{{ route('siswa.presensi') }}" class="flex items-center p-2 text-xl font-bold text-white rounded-lg hover:bg-white hover:bg-opacity-30 active:bg-white active:bg-opacity-30 focus:bg-white focus:bg-opacity-30 mt-8 ">
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-xl font-bold text-white mt-8  rounded-lg hover:bg-white hover:bg-opacity-30 active:bg-white active:bg-opacity-30 focus:bg-white focus:bg-opacity-30 ">
    ...
    <div class="container ">
        <div class="px-7 w-full justify-center items-center">
            ...
            <div class="grid gap-4 gird-cols-2">
                <h3 class="text-2xl font-bold text-danar">FORM EDIT DATA PRESENSI</h3>
            </div>
            <div class="card bg-danar mt-5 ">
                    ...
                    <form action="/siswa/editsimpan/{{$presensi->id_agenda}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="form-control w-full max-w-sm mr-2">
                                <label for="statusabsen" class="label-text text-white text-lg font-bold">Status</label>
                                <select class="select select-bordered bg-white" name="status_agenda"  value="{{ $presensi->status_agenda  }}">
                                    <option disabled selected>Pilih Status Keterangan</option>
                            ...
                            <div class="form-control w-full max-w-sm">
                                <label for="ketagenda" class="label-text text-white text-lg font-bold">Keterangan</label>
                                <input type="text" name="keterangan_agenda" value="{{ $presensi->keterangan_agenda }}" placeholder="Type here" class="input input-bordered w-full max-w-sm bg-white" />
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="form-control w-full max-w-sm mr-2">
                                <label class="label-text text-white text-lg font-bold">Tanggal</label>
                                <input type="date" name="tgl_agenda" value="{{ $presensi->tgl_agenda }}" placeholder="Type here" class="input input-bordered w-full max-w-sm bg-white" />
                            </div>
                            <div class="form-control w-full max-w-sm">
                                <label class="label-text text-white text-lg font-bold">Foto</label>
                                <input type="file" name="foto" src="{{ asset('img') . $presensi->foto }}" placeholder="Type here" class="input input-bordered w-full max-w-sm bg-white px-4 py-2" />
                            </div>
                        </div>
