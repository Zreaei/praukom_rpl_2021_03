        ...
        <div class="p-7 w-full justify-center items-center ">
            ...
            <div class="grid gird-cols-2">
                ...
                <div class="flex justify-end">
                    ...
                    <a href="{{ route('siswa.tambahpengajuan') }}" class="btn btn-primary bg-blue-700 text-white hover:bg-blue-900 font-bold rounded-full"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6"><path fill-rule="evenodd" d="M12 3.75a.75.75 0 01.75.75v6.75h6.75a.75.75 0 010 1.5h-6.75v6.75a.75.75 0 01-1.5 0v-6.75H4.5a.75.75 0 010-1.5h6.75V4.5a.75.75 0 01.75-.75z" clip-rule="evenodd" /></svg></a>
                </div>
            </div>
            <!-- Table pengajuan -->
                            ...
                            ?>
                                @foreach ($pengajuan as $ajuan)
                                    <tr class="border-b bg-white boder-gray-900">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            {{ $ajuan->nama_perusahaan }}
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            {{ $ajuan->alamat_perusahaan }}
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            {{ $ajuan->pimpinan_perusahaan }}
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            {{ $ajuan->telp_perusahaan }}
                                        </td>
                                        <!-- icon Aksi -->
                                        <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                            <div class="flex justify-center">
                                                <div class="px-4 py-4">
                                                    <a href="/siswa/editpengajuan/{{$ajuan->id_surat}}" class="text-indigo-600 hover:text-indigo-900">
                                                ...
                                                <div class="px-4 py-4">
                                                    <a href="/siswa/hapuspengajuan/{{$ajuan->id_surat}}"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-red-600 hover:text-red-800"
