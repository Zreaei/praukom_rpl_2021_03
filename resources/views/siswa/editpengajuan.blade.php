    ...
    <div class="container ">
        <div class="px-7 w-full justify-center items-center">
            ...
            <div class="grid gap-4 gird-cols-2">
                <h3 class="text-2xl font-bold text-blue-700 ">FORM EDIT DATA PENGAJUAN</h3>
            </div>
            <div class="card ">
                <div class="card-body bg-gradient-to-b from-blue-700 to-stone-900 rounded-lg">
                    <form action="/siswa/editsimpanpengajuan/{{$pengajuan->id_surat}}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        value="{{ $pengajuan->nama_perusahaan }}"
                        class="
                            form-control
                            block
                            w-full
                        ...
                        <div class="">
                        <label for="alamatiduka" class="form-label inline-block font-semibold text-white">Alamat Perusahaan</label>
                        <input
                        type="text"
                        name="alamat_perusahaan"
                        value="{{ $pengajuan->alamat_perusahaan}}"
                        class="
                            form-control
                            block
                            w-full
                        ...
                        <div class="">
                        <label for="pimpinan" class="form-label inline-block font-semibold text-white">Nama Pimpinan Perusahaan</label>
                        <input
                        type="text"
                        name="pimpinan_perusahaan"
                        value="{{ $pengajuan->pimpinan_perusahaan }}"
                        class="
                            form-control
                            block
                            w-full
                        ...
                        <div class="mb-3">
                        <label for="tlpiduka" class="form-label inline-block font-semibold text-white">No.Tlp Perusahaan</label>
                        <input
                        type="number"
                        name="telp_perusahaan"
                        value="{{ $pengajuan->telp_perusahaan }}"
                        class="
                            form-control
                            block
                            w-full
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('siswa.pengajuan') }}" class="btn btn-danger px-10 mr-3 bg-gradient-to-b from-blue-700 to-sky-500">Kembali</a>
