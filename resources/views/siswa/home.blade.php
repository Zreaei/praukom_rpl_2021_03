...
<div>
    ...
    <div class="py-10 px-32 justify-center items-center w-full">
        ...
        <div class="flex justify-between mb-5">
            <div class="w-full max-w-xl h-full max-h-60 card border border-white hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg shadow mr-5">
            ...
            <div class="w-full max-w-xl h-full max-h-60 card border border-white hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg shadow ">
        ...
        <div class="flex justify-between gap-5">
            ...
            <div class="w-full max-w-lg h-full max-h-60 card border border-white hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg shadow">
                <a href="{{ route('siswa.prakerin') }}">
                    <div class="flex justify-center h-full p-5">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-28 h-28 text-white"><path fill-rule="evenodd" d="M4.125 3C3.089 3 2.25 3.84 2.25 4.875V18a3 3 0 003 3h15a3 3 0 01-3-3V4.875C17.25 3.839 16.41 3 15.375 3H4.125zM12 9.75a.75.75 0 000 1.5h1.5a.75.75 0 000-1.5H12zm-.75-2.25a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5H12a.75.75 0 01-.75-.75zM6 12.75a.75.75 0 000 1.5h7.5a.75.75 0 000-1.5H6zm-.75 3.75a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5H6a.75.75 0 01-.75-.75zM6 6.75a.75.75 0 00-.75.75v3c0 .414.336.75.75.75h3a.75.75 0 00.75-.75v-3A.75.75 0 009 6.75H6z" clip-rule="evenodd" /><path d="M18.75 6.75h1.875c.621 0 1.125.504 1.125 1.125V18a1.5 1.5 0 01-3 0V6.75z" /></svg>
                    </div>
                    <div class="card-body bg-white rounded-lg bg-opacity-30">
                        <h5 class="text-2xl font-bold tracking-tight text-white text-center">PRAKERIN</h5>
                    </div>
                </a>
            </div>
        </div>
        <div class="flex justify-between gap-5">
            <div class="w-full max-w-lg h-full max-h-60 card border border-white hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg shadow mt-5">
                <a href="{{ route('siswa.presensi') }}">
                    <div class="flex justify-center h-full p-5">
                    ...
                    <div class="card-body bg-white rounded-lg bg-opacity-30">
                        <h5 class="text-2xl font-bold tracking-tight text-white text-center">PRESENSI</h5>
                    </div>
                </a>
            </div>
            <div class="w-full max-w-lg h-full max-h-60 card border border-white hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg shadow mt-5">
                <a href="{{ route('siswa.kegiatan') }}">
                    ...
                    <div class="card-body bg-white rounded-lg bg-opacity-30">
                        <h5 class="text-2xl font-bold tracking-tight text-white text-center">KEGIATAN</h5>
                    </div>
                </a>
            </div>
            <div class="w-full max-w-lg h-full max-h-60 card border border-white hover:bg-[#417EF2] bg-[#2D5EBB] rounded-lg shadow mt-5">
                <a href="{{ route('siswa.verifikasi') }}">
                    ...
                    <div class="card-body bg-white rounded-lg bg-opacity-30">
                        <h5 class="text-2xl font-bold tracking-tight text-white text-center">VERIFIKASI</h5>
                    </div>
                </a>
            </div>
        </div>
