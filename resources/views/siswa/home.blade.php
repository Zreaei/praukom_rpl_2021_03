...
<div class="flex bg-gray-100">
    ...
    <div class="p-10 justify-center items-center w-full">
        <div class="grid justify-items-center">
            <div class="text-3xl font-bold text-danar">
                <h1>PRAKERIN SMKN 1 KOTA BEKASI</h1>
            </div>
            <div class="text-2xl font-bold text-jemjem">
        ...
        <div class="flex justify-between my-2">
            <div class="w-full max-w-2xl h-full max-h-64 card border border-white hover:bg-kahfi bg-danar rounded-lg shadow mr-2">
            ...
            <div class="w-full max-w-2xl h-full max-h-64 card border border-white hover:bg-kahfi bg-danar rounded-lg shadow">
                <a href="{{ route('siswa.pengajuan') }}">
                    <div class="flex justify-center h-full p-5">
        ...
        <div class="flex justify-between ">
            <div class="w-full max-w-lg h-full max-h-60 card border border-white hover:bg-kahfi bg-danar rounded-lg shadow mr-2">
            ...
            <div class="w-full max-w-lg h-full max-h-60 card border border-white hover:bg-kahfi bg-danar rounded-lg shadow">
                <a href="#">
                    <div class="flex justify-center h-full p-5">
