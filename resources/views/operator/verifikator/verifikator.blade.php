    ...
    <div class="flex justify-center">
        ...
        <div class="px-28 py-7 w-full justify-center items-center ">
            <div class="flex justify-between">
                <div>
                    <h3 class="text-2xl font-bold text-[#2D5EBB]">JUMLAH VERIFIKATOR = {{ jumlah_verifikator }}</h3>
                </div>
                <div>
                    ...
                    ?>
                        ...
                        <tr class="bg-[#ffffff] text-[#000000]">
                            ...
                            <td class="text-sm font-medium leading-5 text-center [#ffffff]space-no-wrap ">
                                <div class="flex justify-center">
                                    <div class="px-4 py-4">
                                    <a href="/operator/editverifikator/{{ $item->id_verifikator }}" class="text-indigo-600 hover:text-indigo-900">
                                    ...
                                    <div class="px-4 py-4">
                                        <label for="detail{{$item->id_verifikator}}" class="text-[#2D5EBB] hover:text-opacity-50">
            ...
            <div class="modal">
                <div class="modal-box w-11/12 max-w-2xl bg-[#2D5EBB]">
                    ...
                    <h3 class="text-lg font-bold text-[#ffffff] text-center">TAMBAH DATA VERIFIKATOR</h3>
                    <form action="{{ route('operator.simpanverifikator') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="flex justify-between mt-1">
                            <div class="form-control w-full max-w-sm mr-2">
                                ...
                                <input type="text" name="nip_verifikator" placeholder="Masukkan NIP" class="input input-bordered w-full max-w-sm bg-[#ffffff]" required/>
                            </div>
                            <div class="form-control w-full max-w-sm">
                                <label class="label"><span class="label-text text-[#ffffff] text-md font-bold">NAMA LENGKAP</span></label>
                                <input type="text" name="nama_verifikator" placeholder="Masukkan Nama Lengkap" class="input input-bordered w-full max-w-sm bg-[#ffffff]" required/>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between mt-1">
                            <div class="form-control w-full max-w-2xl">
                                ...
                                <input type="email" name="email" placeholder="Masukkan Email" class="input input-bordered w-full max-w-2xl bg-[#ffffff]" required/>
                            </div>
                        </div>
            ...
            @foreach ($verifikator as $detail)
            <input type="checkbox" id="detail{{$detail->id_verifikator}}" class="modal-toggle" />
            <div class="modal">
                <div class="modal-box w-11/12 max-w-2xl bg-[#2D5EBB]">
                    <label for="detail{{$detail->id_verifikator}}" class="btn btn-ghost btn-sm btn-circle text-[#ffffff] bg-[#2D5EBB] hover:bg-[#ffffff] hover:text-[#2D5EBB] absolute right-2 top-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg></label>
                        ...
                        <div class="flex justify-between mt-2">
                            ...
                            <div class="form-control w-full max-w-sm">
                                <label class="label"><span class="label-text text-[#ffffff] text-lg font-bold">: {{$detail->nip_verifikator}}</span></label>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between mt-2">
                            ...
                            <div class="form-control w-full max-w-sm">
                                <label class="label"><span class="label-text text-[#ffffff] text-lg font-bold">: {{$detail->nama_verifikator}}</span></label>
                            </div>
                        </div>
                ...
                <div class="modal-box w-11/12 max-w-2xl bg-white">
                    ...
                    <div class="flex justify-center pt-4 gap-x-20 gap-y-3">
                        ...
                        <label class="btn btn-ghost btn-base bg-[#E63946] w-36 text-white text-base hover:bg-[#E63946] hover:bg-opacity-70">
                            <a href="/operator/hapusverifikator/{{ $item->id_user}}">
                                Hapus
                            </a>
                        </label>
                    </div>
