...
<div class="fixed w-20 mt-5 overflow-y-auto bg-gray-50 rounded-r-lg bg-gradient-to-b from-[#2D5EBB] to-[#417EF2]">
    <a href="{{ route('operator.pbsekolah') }}" class="flex p-2 text-xl font-bold text-[#ffffff] rounded-r-lg hover:bg-[#ffffff] hover:bg-opacity-30  active:bg-opacity-30 focus:bg-[#ffffff] focus:bg-opacity-30">
...
<div class="grid place-items-center h-screen">
                <div class="py-20 px-20 w-11/12 max-w-2xl bg-[#2D5EBB]">
                    ...
                    <form action="/operator/editsimpanpbsekolah" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                        <input type="hidden"  name="id_pbsekolah" value="{{ $edit[0]->id_pbsekolah }}" />
                        ...
                        <div class="flex justify-between mt-2">
                            <div class="form-control w-full max-w-sm mr-2">
                                ...
                                <input type="text" name="nip_pbsekolah" value="{{ $edit[0]->nip_pbsekolah }}" class="input input-bordered w-full max-w-sm bg-[#ffffff]" required/>
                            </div>
                            <div class="form-control w-full max-w-sm">
                                <label class="label"><span class="label-text text-[#ffffff] text-lg font-bold">NAMA LENGKAP</span></label>
                                <input type="text" name="nama_pbsekolah" value="{{ $edit[0]->nama_pbsekolah }}" class="input input-bordered w-full max-w-sm bg-[#ffffff]" required/>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between mt-2">
                            ...
                            <div class="form-control w-full max-w-sm">
                                ...
                                <input type="number" name="telp_pbsekolah" value="{{ $edit[0]->telp_pbsekolah }}" class="input input-bordered w-full max-w-sm bg-[#ffffff]" required/>
                            </div>
                        </div>
