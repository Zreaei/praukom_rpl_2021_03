...
return new class extends Migration {
   ...
   */
  public function up() {
    DB::unprepared("DROP FUNCTION IF EXISTS generate_new_kode_user");
    DB::unprepared(
        "CREATE FUNCTION generate_new_kode_user()
    RETURNS char(6)
    BEGIN
